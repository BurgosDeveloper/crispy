...
async function runAudit() {
  ...
  const testCases = [
    { input: 13825, expected: 14000, desc: '13,825 COP -> 14,000 COP (> 500 aproxima al millar)' },
    { input: 39500, expected: 39500, desc: '39,500 COP -> 39,500 COP (<= 500 se mantiene en 500)' },
    { input: 39600, expected: 40000, desc: '39,600 COP -> 40,000 COP (> 500 aproxima al millar)' },
    { input: 40000, expected: 40000, desc: '40,000 COP -> 40,000 COP (múltiplo exacto)' },
    { input: 3950,  expected: 4000,  desc: '3,950 COP -> 4,000 COP (> 500 aproxima al millar)' },
